...
execute if score @s task_getting_wood matches 10.. run function hyperworldgen:rewards/reward_task

# Main objective: craft crafting table
scoreboard players add @s task_craft_table 1
execute if score @s task_craft_table matches 1.. run function hyperworldgen:rewards/reward_challenge
